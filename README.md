...
Generates `heliand-synoptic.json` and `heliand-synoptic.txt` for line-by-line comparison of all three editions and all three additional fragmentary witnesses as represented by the data sets generated by the various other pipeline scripts.
